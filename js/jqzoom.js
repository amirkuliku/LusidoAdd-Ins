            ...
            return this.each(function()
                {
                    ...
                    function deactivate()
                    {
                        ...
                        if(!settings.alwaysOn)
                            ...
                            if($('div.jqZoomTitle').length > 0)
                                {
                                ZoomTitleObj.remove();
                                //$('div.jqZoomTitle').css('display','none');
                            }
                            //resetting title
                    ...
                    function Smallimage( image )
                    {
                        ...
                        this.node.onload = function()
                        {
                            ...
                            a.css({'cursor':'url("SB-Resim/zoomin.cur")','display':'block'});

                            if(a.css('position')!= 'absolute' && a.parent().css('position'))
                                {
                                a.css({'cursor':'url("SB-Resim/zoomin.cur")','position':'relative','display':'block'});
                            }
